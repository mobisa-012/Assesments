...
import 'package:email_integration_system/screens/bottom_bar/page/bottom_bar.dart';
import 'package:email_integration_system/screens/signup/signup.dart';
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Image.asset(PathConstants.chat),
              ),
              YMargin(y: 5),
              Text(
